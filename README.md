...
🗺️ Chat Google Maps with AI
A Streamlit App to Chat with Gemini + Visualize Locations on Google Maps

This project is an interactive Streamlit application that combines:

✅ Google Gemini AI
✅ Google Maps (Satellite Tiles)
✅ Reverse Geocoding (OpenCage API)
...
“Best hotels near this location”
“What tourist attractions are close?”
